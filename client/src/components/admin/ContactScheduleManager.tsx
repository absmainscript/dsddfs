          ...
          <CardContent>
            ...
            >
              <SortableContext items={contactItems.map(item => item.id)} strategy={verticalListSortingStrategy}>
                ...
                <Card key={contact.id} className="relative bg-white/80 backdrop-blur-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                  <div className="p-4">
                    <div className="flex items-start gap-3">
                      <div 
                        className="cursor-grab active:cursor-grabbing text-gray-400 hover:text-gray-600 transition-colors duration-200 mt-1 flex-shrink-0"
                        {...attributes}
                        {...listeners}
                      ...
                      >
                        <IconComponent icon={contact.icon} className="text-lg" />
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-sm text-gray-600 truncate">{contact.description}</p>
                          </div>
                          <Badge variant={contact.isActive ? "default" : "secondary"} className="flex-shrink-0">
                            {contact.isActive ? "Ativo" : "Inativo"}
                          </Badge>
                        </div>
                        <p className="text-xs text-gray-500 break-all mb-3">{contact.link}</p>
                        ...
                        <div className="flex gap-2 justify-end">
                          ...
                          <Button variant="destructive" size="sm" onClick={() => {
                            const newItems = contactItems.filter((c: any) => c.id !== contact.id);
                            updateContactSettings.mutate({ contact_items: newItems });
                          }} className="h-8 px-3">
